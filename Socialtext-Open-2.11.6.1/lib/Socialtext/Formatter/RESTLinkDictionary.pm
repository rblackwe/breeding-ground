...
field file     => '/data/workspaces/%{workspace}/attachments/%{page_uri}:%{id}/files/%{filename}';
field image    => '/data/workspaces/%{workspace}/attachments/%{page_uri}:%{id}/files/%{filename}';
